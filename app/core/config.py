...
class Settings(BaseSettings):
    ...
    FREQUENCY_OF_CLEANING_SUBMISSIONS: int = _parse_value(config['DB CONNECTION SETTINGS']['FREQUENCY_OF_CLEANING_SUBMISSIONS'])
    FREQUENCY_OF_CLEANING_API_TOKENS: int = _parse_value(config['DB CONNECTION SETTINGS']['FREQUENCY_OF_CLEANING_API_TOKENS'])
    ...
    PROTECTED_SOFTWARE_CONFIGURATION: bool = _parse_value(config['OTHER SETTINGS']['PROTECTED_SOFTWARE_CONFIGURATION'])
    PROTECTED_HARDWARE_CONFIGURATION: bool = _parse_value(config['OTHER SETTINGS']['PROTECTED_HARDWARE_CONFIGURATION'])
